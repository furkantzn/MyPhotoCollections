...
import com.example.myphotocollections.ui.view.listItems.CategoryCardItem
import com.example.myphotocollections.ui.viewmodel.NavigationViewModel

@Composable
fun CategoriesPage(navController: NavController, viewModel: NavigationViewModel = hiltViewModel()) {
